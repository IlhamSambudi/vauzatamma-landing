...
export default function WhatsAppButton() {
    ...
    return (
        <div className="fixed bottom-7 right-6 z-50 flex flex-col items-end gap-3">
            {/* Tooltip */}
            <AnimatePresence>
                {hovered && (
                    <motion.div
                        ...
                        exit={{ opacity: 0, x: 10 }}
                        className="bg-white border border-sage/50 shadow-card-lg text-gray-800 text-xs font-semibold px-4 py-2.5 rounded-xl whitespace-nowrap"
                    >
                        Chat via WhatsApp 💬
                    </motion.div>
                )}
            ...
            >
                ...
                >
                    ...
                    <div className="relative w-14 h-14 bg-[#25D366] hover:bg-[#1dbd5b] rounded-full shadow-gold flex items-center justify-center transition-colors duration-200">
